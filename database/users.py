...
_seekers_cache: Dict[Tuple[int, int, Optional[str], Optional[str]], Tuple[float, List[Dict[str, Any]]]] = {}
...
# ================= ОБНОВЛЕНИЕ ДАННЫХ =================
def update_seeker_profile(telegram_id: int, **updates) -> bool:  # noqa: C901
...
def get_all_seekers(limit: int = 100, offset: int = 0, city: str = None, status: str = None) -> List[Dict[str, Any]]:
