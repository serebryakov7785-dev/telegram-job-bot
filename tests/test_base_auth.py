...
class TestAuthHandlers:
    ...
    def handler(self, bot):
        ...
        with patch('handlers.auth.role_auth.RoleAuth') as MockRole, \
            ...
            handler.mock_seeker = MockSeeker.return_value
            handler.mock_employer = MockEmployer.return_value
            handler.mock_login = MockLogin.return_value
            return handler
