...
from database.users import get_user_by_credentials, create_job_seeker
...
class TestSecurity:
    ...
    def test_idor_edit_vacancy(self):
        ...
        with patch('database.get_user_by_id', return_value={'id': 1}), \
             patch('database.get_employer_vacancies', return_value=[{'id': 555}]):  # У него есть только 555
