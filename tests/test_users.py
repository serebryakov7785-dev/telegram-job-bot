...
class TestUserOperations:
    ...
    def test_update_employer_profile(self, test_db):
        ...
        create_employer({
            'telegram_id': 4004, 'password': 'P', 'company_name': 'Old Company',
            'contact_person': 'Old Person', 'phone': '998904445566', 'email': 'e@e.uz', 'city': 'Bukhara'
        })

        # Обновляем
        updates = {'company_name': 'New Company', 'city': 'Tashkent', 'description': 'Updated description'}
    ...
    def test_get_statistics(self, test_db):
        ...
        for i in range(3):
            create_job_seeker({
                'telegram_id': 6000 + i, 'password': 'p', 'phone': f'9989060000{i:02d}',
                'email': f'stat_s{i}@test.uz', 'full_name': f'Stat Seeker {i}', 'age': 20, 'city': 'T'
            })
    ...
    def test_create_seeker_duplicate_phone(self, test_db):
        ...
        create_job_seeker({
            'telegram_id': 8001, 'password': 'p', 'phone': '+998908000001',
            'email': 'user1@test.com', 'full_name': 'User One', 'age': 20, 'city': 'T'
        })
        # Попытка создать второго с тем же телефоном
        result = create_job_seeker({
            'telegram_id': 8002, 'password': 'p', 'phone': '+998908000001',
            'email': 'user2@test.com', 'full_name': 'User Two', 'age': 20, 'city': 'T'
        })
    ...
    def test_create_seeker_duplicate_email(self, test_db):
        ...
        create_job_seeker({
            'telegram_id': 8003, 'password': 'p', 'phone': '+998908000003',
            'email': 'duplicate@test.com', 'full_name': 'User Three', 'age': 20, 'city': 'T'
        })
        # Попытка создать второго с тем же email
        result = create_job_seeker({
            'telegram_id': 8004, 'password': 'p', 'phone': '+998908000004',
            'email': 'duplicate@test.com', 'full_name': 'User Four', 'age': 20, 'city': 'T'
        })
        assert result is False
    ...
    def test_get_user_by_id_caching(self, test_db):
        ...
        user_data = {
            'telegram_id': 12001, 'password': 'p', 'phone': '12001',
            'email': 'cache@test.com', 'full_name': 'Cache User', 'age': 20, 'city': 'T'
        }
        ...
        _user_cache[12001] = (time.time(), {'full_name': 'Cached Name', 'role': 'seeker'})
    ...
    def test_get_all_employers(self, test_db):
        ...
        create_employer({
            'telegram_id': 9001, 'password': 'p', 'company_name': 'Co 1', 'contact_person': 'CP',
            'phone': '998909000001', 'email': 'co1@test.com', 'city': 'T'
        })
        create_employer({
            'telegram_id': 9002, 'password': 'p', 'company_name': 'Co 2', 'contact_person': 'CP',
            'phone': '998909000002', 'email': 'co2@test.com', 'city': 'T'
        })
    ...
    def test_get_user_by_credentials_seeker(self, test_db):
        ...
        create_job_seeker({
            'telegram_id': 15001, 'password': 'p', 'phone': '+998901500001',
            'email': 'cred_seeker@test.com', 'full_name': 'Cred Seeker', 'age': 20, 'city': 'T'
        })
    ...
    def test_get_user_by_credentials_employer(self, test_db):
        ...
        create_employer({
            'telegram_id': 15002, 'password': 'p', 'company_name': 'Cred Co', 'contact_person': 'CP',
            'phone': '+998901500002', 'email': 'cred_emp@test.com', 'city': 'T'
        })
